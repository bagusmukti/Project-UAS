...
<body>
    <div class="wrapper d-flex">
            ...
            <nav class="nav flex-column">
                ...
                <div class="dropdown mt-2">
                    ...
                    <ul class="dropdown-menu w-100">
                        <li>
                            <a class="dropdown-item" href="form_pengaduan.php">
                                Buat Aduan
                        ...
                        <li><a class="dropdown-item" href="riwayat_aduan.php">Riwayat</a></li>
                    </ul>
                </div>
        ...
        <div class="main-container">
            <a class="header-user-admin" href="edit_profile.php">
                <div class="user-info">
