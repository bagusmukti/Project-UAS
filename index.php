...
<body style="background-color: rgb(138, 193, 247);">
    <div>
        ...
        <div class="container">
            <div class="row">
                <div class="col-4">
                    <img src="assets/uploaded_pics/successful-businessman-standing-confidently.png" width="300rem" alt="">
                </div>
                <div class="col-4">
                ...
                <div class="col-4">
                    <img src="assets/uploaded_pics/successful-businessman-standing-confidently.png" width="300rem" alt="" style="transform: scaleX(-1);">
                </div>
            </div>
            <!DOCTYPE html>
            <html lang="id">
